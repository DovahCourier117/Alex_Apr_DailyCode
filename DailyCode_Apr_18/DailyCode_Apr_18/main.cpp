...
int main(int argc, char **argv) {
	...
	float ball_2_dx = -1.5, ball_2_dy = 3.0;
	...
	al_set_target_bitmap(ball_2);
	al_clear_to_color(al_map_rgb(55, 55, 215));
	...
	while (!doexit) {
		...
		if (ev.type == ALLEGRO_EVENT_TIMER) {//////////////////////////////////////////////////////
			...
			if (ball_2_x < 0 || ball_2_x > 800 - 20) {
				//flip the x direction
				ball_2_dx = -ball_2_dx;
			}
			//if the box hits the top wall OR the bottom wall
			if (ball_2_y < 0 || ball_2_y > 800 - 20) {
				//flip the y direction
				ball_2_dy = -ball_2_dy;
			}
			...
			//brick collision section
			if ((brick1.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick1.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick1.killBrick();
			}
			if ((brick2.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick2.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick2.killBrick();
			}
			if ((brick3.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick3.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick3.killBrick();
			}
			if ((brick4.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick4.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick4.killBrick();
			}
			if ((brick5.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick5.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick5.killBrick();
			}
			if ((brick6.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick6.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick6.killBrick();
			}
			if ((brick7.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick7.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick7.killBrick();
			}
			if ((brick8.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick8.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick8.killBrick();
			}
			if ((brick9.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick9.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick9.killBrick();
			}
			if ((brick10.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick10.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick10.killBrick();
			}
			if ((brick11.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick11.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick11.killBrick();
			}
			if ((brick12.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick12.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick12.killBrick();
			}
			if ((brick13.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick13.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick13.killBrick();
			}
			if ((brick14.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick14.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick14.killBrick();
			}
			if ((brick15.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick15.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick15.killBrick();
			}
			if ((brick16.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick16.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick16.killBrick();
			}
			if ((brick17.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick17.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick17.killBrick();
			}
			if ((brick18.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick18.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick18.killBrick();
			}
			if ((brick19.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick19.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick19.killBrick();
			}
			if ((brick20.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick20.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick20.killBrick();
			}
			if ((brick21.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick21.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick21.killBrick();
			}
			if ((brick22.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick22.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick22.killBrick();
			}
			if ((brick23.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick23.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick23.killBrick();
			}
			if ((brick24.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick24.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick24.killBrick();
			}
			if ((brick25.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick25.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick25.killBrick();
			}
			if ((brick26.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick26.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick26.killBrick();
			}
			if ((brick27.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick27.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick27.killBrick();
			}
			if ((brick28.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick28.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick28.killBrick();
			}
			if ((brick29.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick29.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick29.killBrick();
			}
			if ((brick30.collision(ball_2_x, ball_2_y, 20, 20) == 1) && brick30.isDead() == 0) {
				//play annoying sound effect here
				ball_2_dx = -ball_2_dx;
				ball_2_dy = -ball_2_dy;
				brick30.killBrick();
		...
		if (redraw && al_is_event_queue_empty(event_queue)) {
			...
			al_draw_bitmap(ball_2, ball_2_x, ball_2_y, 0);
